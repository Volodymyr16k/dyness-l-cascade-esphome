# Dyness-L Internal Cascade CAN Frames Documentation
...
## Master BMS Node 1 Frames (`0x18F211xx`)

### Frame `0x18F21121` — Master Pack Status & Average Cell
...
- **Byte 0-1:** MCU Core Clock Synchronization Tick (Used to prevent CAN collisions in cascade)
...
## Slave BMS Node 2 Frames (`0x18F212xx`)

### Frame `0x18F21221` — Slave Pack Status & Average Cell
...
## Global Cascade Synchronization

### Frame `0x18F20102` — Cascade Heartbeat Loop
